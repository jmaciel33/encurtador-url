package com.encurtador.mseventstore.config;

import com.encurtador.mseventstore.service.EventListenerImpl;
...
public class BrokerConfig {
    ...
    public Binding binding(Queue queue, TopicExchange eventExchange) {
        return BindingBuilder.bind(queue).to(eventExchange).with(routingKeyCommand);
    }
    ...
    public String getRoutingKeyCommand() {
        return routingKeyCommand;
    }

    public void setRoutingKeyCommand(String routingKeyCommand) {
        this.routingKeyCommand = routingKeyCommand;
    }
}
