...
import com.encurtador.mseventstore.config.BrokerConfig;
...
public class EventSenderImpl implements EventSender {
    ...
    @Override
    public Message buidMessage(CommandEvent event) {
    ...
    public void sendCommand(CommandEvent event) {
        this.rabbitTemplate.send(this.brokerConfig.getExchange(), this.brokerConfig.getRoutingKeyRefresh(), this.buidMessage(event));
        LOGGER.info("Event sent to the queue: {}", this.brokerConfig.getRoutingKeyRefresh());
    }
}